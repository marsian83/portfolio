<script>
  ...
  onMount(() => {
    (function (w) {
      ...
      var canvas_width = Math.ceil(vw/50) * 50;;
      var canvas_height = Math.ceil(vh/50) * 50;;
...
<section bind:this={sect} class="bg-background relative overflow-hidden">
  <canvas id="c" />
</section>
